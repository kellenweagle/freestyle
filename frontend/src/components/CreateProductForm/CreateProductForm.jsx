...
function CreateProductForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare image data to be sent to the backend
    const productData = {
      ...form,
      images: [
        { url: form.previewImage, previewImg: true },
        { url: form.image1, previewImg: false },
        { url: form.image2, previewImg: false },
        { url: form.image3, previewImg: false }
      ]
    };

    // Dispatch the thunk action
    const res = await dispatch(createProductThunk(productData));
